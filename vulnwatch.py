...
<title>VulnWatch Report</title><style>
...
</style></head><body><main><p class="sub" style="letter-spacing:.14em;color:var(--cyan);margin-bottom:5px">DEFENSIVE SECURITY INTELLIGENCE</p><h1>VulnWatch</h1><p class="sub">Top {len(findings)} current cross-platform vulnerabilities · generated {generated} · risk score /100</p>
